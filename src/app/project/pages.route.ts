...
const routerConfig: Routes = [
  {
    ...
    children: [
      ...
      { path: 'convenios/detalhes-convenio', component: DadosConvenioComponent },
      { path: 'convenios/novo-convenio', component: NewConvenioComponent },
      { path: 'convenios/edit-convenio', component: EditConvenioComponent },
      { path: 'convenios/convenio-data/:id', component: AssociacaoConvenioDataComponent },
      ...
      { path: 'licitacoes/licitacao-data/:_id', component: AssociacaoLicitacaoDataComponent, resolve: { bid: BidGetByIdResolve } },
      ...
      { path: 'itens-custo/editar-item/:_id', component: UpdateCostItemsComponent, resolve: { costItem: CostItemGetByIdResolve } },
      { path: 'itens-custo/dados-item', component: CostItemsDataComponent },
      { path: 'item-group', component: ItemGroupComponent },
      { path: 'item-group/new-group', component: NewGroupComponent },
      { path: 'item-group/edit-group', component: EditGroupComponent },
      { path: 'proposal-screening', component: ProposalScreeningComponent },
      { path: 'licitacoes', component: AdministrationLicitacoesComponent },
      { path: 'licitacoes/detalhes-licitacoes/:_id', component: AdministrationDetailLicitacaoComponent, resolve: { bid: BidGetByIdResolve } },
      ...
      { path: 'fornecedor/detalhes-licitacoes', component: FornecedorDetalheLicitacaoComponent },
