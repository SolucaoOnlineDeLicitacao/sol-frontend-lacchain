...
export class NewConvenioComponent {
  ...
  verifyInputs() {
    if (this.form.controls['number'].value === undefined || this.form.controls['number'].value === '' || this.form.controls['number'].value === null) {
    ...
    else if (this.form.controls['object'].value === undefined || this.form.controls['object'].value === '' || this.form.controls['object'].value === null) {
    ...
    else if (this.form.controls['state'].value === undefined || this.form.controls['state'].value === '' || this.form.controls['state'].value === null) {
    ...
    else if (this.form.controls['city'].value === undefined || this.form.controls['city'].value === '' || this.form.controls['city'].value === null) {
    ...
    else if (this.form.controls['price'].value === undefined || this.form.controls['price'].value === '' || this.form.controls['price'].value === null) {
    ...
    else if (this.form.controls['datesub'].value === undefined || this.form.controls['datesub'].value === '' || this.form.controls['datesub'].value === null) {
    ...
    else if (this.form.controls['datemat'].value === undefined || this.form.controls['datemat'].value === '' || this.form.controls['datemat'].value === null) {
    ...
    else if (this.form.controls['situation'].value === undefined || this.form.controls['situation'].value === '' || this.form.controls['situation'].value === null) {
    ...
    else if (this.form.controls['association'].value === undefined || this.form.controls['association'].value === '' || this.form.controls['association'].value === null) {
    ...
    else if (this.form.controls['review'].value === undefined || this.form.controls['review'].value === '' || this.form.controls['review'].value === null) {
